...
| Module | Description |
|---|---|
| [🤖 marp.brain](https://github.com/Mutilar/MarpPi) | Raspberry Pi 5 — 4-axis stepper control, dual input (USB joystick / Wi-Fi Direct UDP), low-latency H.264 video streaming, auto-stop safety |
| [🎮 marp.gamepad](https://github.com/Mutilar/MarpGamepad) | Valve Steam Deck — Unity 6.0 wireless teleoperation client with real-time MJPEG video feed, native Steam Deck & Xbox controller support |
...
| [🎮 bitnaughts.unity](https://github.com/bitnaughts/bitnaughts.unity) | Unity 6.0 game client — players navigate a spaceship and solve programming challenges through an in-game terminal |
| [👨‍💻 bitnaughts.interpreter](https://github.com/bitnaughts/bitnaughts.interpreter) | Assembly interpreter engine — steps through each OP Code instruction-by-instruction |
| [📺 bitnaughts.github.io](https://github.com/bitnaughts/bitnaughts.github.io) | WebGL front-end — [bitnaughts.io](https://bitnaughts.io) |
| [📡 bitnaughts.mainframe](https://github.com/bitnaughts/bitnaughts.mainframe) | Serverless Azure Function App back-end with MongoDB persistence |
| [🎤 bitnaughts.voice](https://github.com/bitnaughts/bitnaughts.voice) | A.I. voice narration via TorToiSe TTS |
...
|---|---|---|
| [👑 The Nobles](https://archidekt.com/decks/15093247/the_nobles) | Edgar Markov | Mardu Vampires — eminence token flood with anthem effects & tutor package |
| [👹 The Demons](https://archidekt.com/decks/15094042/the_demons) | Clavileño, First of the Blessed | Orzhov Aristocrats — sacrifice/recursion engine with denial & tutor package |
...
| SWE Intern | 🔬 Roche | May – Dec 2018 | Santa Clara, CA |
...
| Web Developer, MAC Organizer | [🏙️ CITRIS & Banatao Institute](https://github.com/citris-ucmerced) | May 2017 – Dec 2018 | Merced, CA |
...
| Instructor | 📚 Learn BEAT | 2018 | Merced, CA |
| Outreach Lead | 💻 Association of Computing Machinery | 2018 | Merced, CA |
| Electrical Lead, Treasurer | 🤖 Red Tie Robotics FRC 1458 | Aug 2014 – May 2016 | Danville, CA |
| Volunteer | 🤖 Alamo Robotics | 2016 | Alamo, CA |
...
| [🗠 Ozone](https://github.com/SSites/Ozone) | Innovate to Grow — React + Mapbox interactive sustainability map for UC Merced | |
...
| [⚡ AMAX ESD](https://github.com/Mutilar) | FIRST Robotics × AMAX — real-time ESD bracelet disconnect detection for server manufacturing | |
...
Game programming offers unique coding challenges directly translatable into other computer science fields.

| Game | Description |
|---|---|
| [☄ BitNaughts](https://github.com/bitnaughts/bitnaughts) | Code Gamified — educational programming video-game (Unity 6.0, C#) |
| [ℹ Iterate](https://github.com/Mutilar/Iterate) | Code Mobilized — tap-based mobile code editor (Unity, C#) |
| [🧭 SeeRäuber](https://github.com/plebeiathon/seerauber) | Pirating Code — distributed-AI pirate strategy game (Unity3D, C#) |
| [🌸 Graviton](https://github.com/Mutilar/Graviton) | Retro Sci-fi Tower Defense — satellite defense vs. alien swarms (Unity, C#) |
| [🕹️ SpaceNinjas](https://github.com/Mutilar/SpaceNinjas) | Intro to Game Design — 2D platformer boilerplate for teaching (Unity 5, C#) |
| [✨ VooDoo](https://github.com/Mutilar/Voodoo) | Minion-Swarming Madness — 2D RTS with procedural terrain & boss fights (Unity 5.6, C#) |
...
[LinkedIn](https://www.linkedin.com/in/brian-hungerman/) · [GitHub](https://github.com/Mutilar) · [Email](mailto:brianhungerman@gmail.com)
